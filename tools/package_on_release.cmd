...
if  "%CONFIGURATION%"=="Release" (
    7z a %BUILD_FOLDER%\mdlgen-%VERSION%-release.zip %BUILD_FOLDER%\LICENSE %BUILD_FOLDER%\LICENSE-libyaml %BUILD_FOLDER%\LICENSE-YamlDotNet %BUILD_FOLDER%\src\ModelGenerator\bin\Release\mdlgen.exe
